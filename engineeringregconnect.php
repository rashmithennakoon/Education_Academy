<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
        ...
        if (isset($_POST['name']) && isset($_POST['id']) && isset($_POST['dob']) && isset($_POST['email']) && isset($_POST['address']) && isset($_POST['phone']) && isset($_POST['degree']) && isset($_POST['pict'])) {
            ...
            $sql = "INSERT INTO `engineering` (`Full_Name`, `ID`, `DOB`, `Email`, `Address`, `Telephone_Number`,`Degree`, `Payment_Slip_Link`) VALUES ('$name','$id','$dob','$email', '$address', '$phone','$degree', '$pict')";
